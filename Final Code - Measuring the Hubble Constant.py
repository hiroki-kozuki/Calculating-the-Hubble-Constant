...
@author: CID: 02042390
"""
#Submission confirmation number: b45f4acd-e5b7-41ae-a139-a1f7af1e55b6.
...
spectral_line = np.loadtxt(r'C:\Users\ginta\OneDrive\HIROKI\Imperial College London\Year 1\Y1 Computing Lab\Computing Project 1 - Hubble Constant\CompProjectData\Halpha_spectral_data.csv', skiprows=5, delimiter=',') 
# load data file for galaxy distances.
distance = np.loadtxt(r'C:\Users\ginta\OneDrive\HIROKI\Imperial College London\Year 1\Y1 Computing Lab\Computing Project 1 - Hubble Constant\CompProjectData\Distance Data.csv', skiprows=1, delimiter=',') 
...
frequency_plus_spectral_line = np.loadtxt(r'C:\Users\ginta\OneDrive\HIROKI\Imperial College London\Year 1\Y1 Computing Lab\Computing Project 1 - Hubble Constant\CompProjectData\Halpha_spectral_data.csv', skiprows=4, delimiter=',') 
...
def lin_gauss(frequency,a,mu,sig,m,c):
    lin = m*frequency+c
    gauss = a*sp.exp(-(frequency-mu)**2/(2*sig**2))
    return lin + gauss
